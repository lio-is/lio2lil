...
// Class for objects that can be attacked
public class Fighter : MonoBehaviour
{
    // Basic parameters: Health, maximum health, speed recovery coefficient
    [Header("------Health System------")]
    public int hitPoint = 50;               // Current health
    public int maxHitPoint = 150;            // Maximum health
    public float pushRecoverySpeed = 0.1f;  // Speed of recovering from being pushed
